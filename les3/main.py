...
if crossroad == "left":
    ...
    if water == "wait":
        ...
        if door == "yellow":
            print("You found the tressure. Congrats")
        elif door == "blue":
            print("You enter a room of beasts. Game Over.")
        else:
            print("You enter a room of flames. Game Over.")
    else:
        print("The water was full of monsters. Game Over.")
else:
    print("You fell down a holl. Game Over.")